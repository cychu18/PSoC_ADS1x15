...
typedef enum {
  RATE_ZERO = ADS1115_REG_CONFIG_DR_8SPS,
  RATE_TWO = ADS1115_REG_CONFIG_DR_16SPS,
  RATE_FOUR = ADS1115_REG_CONFIG_DR_32SPS,
  RATE_SIX = ADS1115_REG_CONFIG_DR_64SPS,
  RATE_EIGHT = ADS1115_REG_CONFIG_DR_128SPS,
  RATE_TEN = ADS1115_REG_CONFIG_DR_250SPS,
  RATE_TWELVE = ADS1115_REG_CONFIG_DR_475SPS,
  RATE_FOURTEEN = ADS1115_REG_CONFIG_DR_860SPS,
} adsRate_t;
